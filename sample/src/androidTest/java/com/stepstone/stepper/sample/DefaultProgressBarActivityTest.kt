...
/**
 * Performs tests on a progress bar stepper i.e. the one with `ms_stepperType="progress_bar"`.
 *
 * @author Piotr Zawadzki
 */
@LargeTest
class DefaultProgressBarActivityTest : AbstractActivityTest<DefaultProgressBarActivity?>() {
    @org.junit.Test

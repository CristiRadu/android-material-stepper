...
/**
 * Performs tests on a styled progress bar stepper i.e. the one with `ms_stepperType="progress_bar"`.
 *
 * @author Piotr Zawadzki
 */
@LargeTest
class StyledProgressBarActivityTest : AbstractActivityTest<StyledProgressBarActivity?>() {
    @org.junit.Test
